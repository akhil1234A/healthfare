                ...
                <!-- ============================================================== -->
				  <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h2 class="card-title">Add FAQS</h2>
                                     ...
                                     <?php 
											...
											while($row = mysqli_fetch_array($result))
												
															{
																...
																?>
                                    <div class="question">Q: <?php echo $row['question'] ?> <a href="edit-faq.php?id=<?php echo $row['faqid'] ?>"><i class="ti-pencil-alt" style="color:#009efb;text-align:right"> Edit</i></a></div>
