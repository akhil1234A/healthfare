            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">User Support</h3>
                        ...
                        <div class="card">
                            <div class="card-body">   <?php 
												...
												$row = mysqli_fetch_array($result);
																	...
																	?>
                                <h2 class="card-title">Update Help Request of <?php echo $row['name']; ?></h2>
                                <form action="update-helprequest.php" method="post" >
                                    <div class="form-group">
                            
                                        <div class="row">
												
                                            <div class="col-md-12">
											<label class="col-md-12 mb-0" for="height">Assigned To</label>
                                                <select name="assigned_to"  class="form-control ps-0 form-control-line form-control">
												<?php 
												require "connection.php"; 
												$sql1 = "SELECT * FROM dietition ";
												$result1 = mysqli_query($conn, $sql1);
												while($row1 = mysqli_fetch_array($result1))
												{
												?>
												<option <?php if($row['assigned_to']==$row1['name']) echo "selected" ?> value="<?php echo $row1['name'] ?>"><?php echo $row1['name'] ?></option>
												<?php } ?>
												</select> </div>
