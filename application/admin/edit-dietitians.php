            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Edit Dietitians</h3>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Edit Dietitians</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <!-- ============================================================== -->
				  <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h2 class="card-title">Edit Dietition</h2>
                                <form action="update-dietitians.php" method="post" >
                                    <div class="form-group">
                                        ...
                                        <div class="row">
												...
												$sql = "SELECT * FROM dietition where dietid='$id' ";
                                        ...
                                        <div class="row">
											...
											<label class="col-md-12 mb-0" for="weight">Contact</label>
                                                <input type="text" name="contact"  class="form-control ps-0 form-control-line form-control" value="<?php echo $row['contact'] ?>">
                                            </div>
											 <div class="col-md-6">
                                    ...
                                    <input type="hidden" name="id" value="<?php echo $row['dietid']; ?>">
                                        <div class="row">
                                            <div class="col-md-12">
