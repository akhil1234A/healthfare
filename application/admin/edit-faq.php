                ...
                <!-- ============================================================== -->
				  <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h2 class="card-title">Edit FAQS</h2>
                                        ...
                                        <div class="row">
                                              <?php 
												...
												$row = mysqli_fetch_array($result);
																	...
																	?>
                                            <div class="col-md-12">
											<label class="col-md-12 mb-0" for="height">Qustion</label>
                                                 <textarea class="form-control" name="question" rows="3"  required><?php echo $row['question'] ?></textarea>
                                            </div>
											<input type="hidden" name="id" value="<?php echo $row['faqid']?>">
											</div>
                                        <div class="row">
                                             <div class="col-md-12">
											 <label class="col-md-12 mb-0" for="height">Answer</label>
                                                <textarea class="form-control" name="answer" rows="3"  required><?php echo $row['answer'] ?></textarea>
                                            </div>
                                    </div>
                                        <div class="row">
                                            <div class="col-md-12">
