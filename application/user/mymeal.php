    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-12 align-self-center">
                        <h3 class="page-title mb-0 p-0">My Meals</h3>
            ...
            <div class="container-fluid">
                ...
                <div class="container-fluid">
				<div class="row">
                    		<form action="mymeal.php" method="get">
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
							 <label>Choose Family Member</label>
                                <select id="profileSwitch" name="member" class="form-select" required>
								<option>Choose Family Member</option>
								 <?php
									...
									<option value="<?php echo $row['fid'] ; ?>" <?php if(isset($_GET['submit'])&&($_GET['member']==$row['fid'])){ echo "selected";}?>><?php echo $row['name'] ; ?></option>
									<?php } ?>
								</select></br>
...
$sql1 = "SELECT * FROM health_condition WHERE fid='$fid' && uid = '" . $userData['id'] . "'";
$result1 = mysqli_query($conn, $sql1);
$row1 = mysqli_fetch_array($result1);

if(!empty($row1)){
    $hc=$row1['health_condition'];
$sql2 = "select * from foods where health_condition='$hc'";
...
while($row2 = mysqli_fetch_array($result2))
				{
					?>
                        <div class="col-lg-4 col-md-4">
                            <div class="card">
                                <img class="card-img-top img-responsive" src="../dietitian/<?php echo $row2['image']; ?>" alt="Card">
                                <div class="card-body">
                                   
                                    <h3 class="font-normal"><?php echo $row2['name']; ?></h3>
                                    <p style="color:#a9a9a9">Recommended for <?php echo $hc; ?></p>
                                    <p><?php echo $row2['nutri_info']; ?></p>
                                </div>
                            </div>
                        </div>
                        <!-- Column -->
						...
						<?php }}
$sql = "SELECT * FROM food_review WHERE family_member='$fid' && status='Completed' && user = '" . $userData['id'] . "'";
$result = mysqli_query($conn, $sql);
while($row = mysqli_fetch_array($result))
				{
					?>
                        <div class="col-lg-4 col-md-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <h3 class="font-normal"><?php echo $row['food_name']; ?></h3>
						...
						<?php }  }
							...
							$sql = "SELECT * FROM food_review WHERE user = '" . $userData['id'] . "' ";
$result = mysqli_query($conn, $sql);
while($row = mysqli_fetch_array($result))
				{
					?>
