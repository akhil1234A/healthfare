            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Add Family Member</h3>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="insert-family-member.php" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                            
                                        <div class="row">
                                            <label class="col-md-12 mb-0" for="height">Name</label>
                                            <div class="col-md-12">
                                                <input type="text" name="name"  class="form-control ps-0 form-control-line form-control">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <label class="col-md-12 mb-0" for="weight">Relation</label>
                                            <div class="col-md-12">
                                                <input type="text" name="relation"  class="form-control ps-0 form-control-line form-control">
                                            </div>
                                        </div>
                                    
                                        <div class="row">
                                            <label class="col-md-12 mb-0" for="age">Profile Image</label>
                                            <div class="col-md-12">
