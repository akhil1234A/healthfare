                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-body profile-card">
                                <center class="mt-4"> <img src="<?php echo $userData['img']; ?>"
                                        class="rounded-circle" width="150" />
                                    <h4 class="card-title mt-2"><?php echo $userData['name']; ?></h4>
									
                                  <div class="col-sm-12  ">
                                           <a href="edit-profilepic.php?id=<?php echo $userData['id'];  ?>" class="btn btn-success mx-auto mx-md-0 text-white" type="submit" name="edit">Update
                                                Photo</a>
                                        </div>
...
?>					   
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-7">
                        <div class="card">
							...
							<center><h4>Edit Profile</h4></center>
                                <form class="form-horizontal form-material mx-2" method="post" action="edit-user-profile.php">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="email" value="<?php echo $userData['email']; ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" value="<?php echo $userData['number']; ?>"
                                                class="form-control ps-0 form-control-line" name="number">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12 mb-0">Gender</label>
                                        <div class="col-md-12">
                                            <input type="text" value="<?php echo $userData['gender']; ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" value="<?php echo $userData['country']; ?>"
                                                class="form-control ps-0 form-control-line" name="country">
                                        </div>
                                    </div>
									<input type="hidden" name="id" value="<?php echo $userData['id']; ?>">
									<div class="form-group">
									    <div class="col-sm-12 d-flex">
                                            <button class="btn btn-success mx-auto mx-md-0 text-white" type="submit" name="edit">Submit
                                                </button>
                                        </div>
                                    </div>
                                    <div class="form-group">
				   ...
				   <?php } else { ?>
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-7">
                        <div class="card">
                            <div class="card-body">
                                <form class="form-horizontal form-material mx-2" method="get" action="profile.php">
                                    <div class="form-group">
                                        <label class="col-md-12 mb-0">Name</label>
                                        <div class="col-md-12">
                                            <input type="text" value="<?php echo $userData['name']; ?>"
                                                class="form-control ps-0 form-control-line" name="name" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-email" class="col-md-12">Email</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" value="<?php echo $userData['number']; ?>"
                                                class="form-control ps-0 form-control-line" name="number" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12 mb-0">Gender</label>
                                        <div class="col-md-12">
                                            <input type="text" value="<?php echo $userData['gender']; ?>"
                                                class="form-control ps-0 form-control-line" name="gender" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-12">Country</label>
                                        <div class="col-md-12">
                                            <input type="text" value="<?php echo $userData['country']; ?>"
                                                class="form-control ps-0 form-control-line" name="country" disabled>
                                        </div>
                                    </div>
									
									<div class="form-group">
									    <div class="col-sm-12 d-flex">
                                            <button class="btn btn-success mx-auto mx-md-0 text-white" type="submit" name="edit">Edit Profile
                                                </button>
                                        </div>
                                    </div>
                                    <div class="form-group">
