    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">My Health</h3>
            ...
            <div class="container-fluid">
                <!-- ============================================================== -->
                <!-- Start Page Content -->
				<form method="post" action="insert-health-condition.php">
				<div class="row">
				...
				<div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                 <h2 class="card-title">Add Health Condition</h2></h2>
                     <div class="form-group">
                          <label class="col-sm-12">Choose Family Member:</label>
                        <div class="col-sm-12 border-bottom">
                <select name="member" class="form-select shadow-none border-0 ps-0 form-control-line">
							
								 <?php
									require "connection.php"; 
									$query = "SELECT * from familymember where userid=".$userData['id'];
                    ...
                    <div class="form-group">
                        <label class="col-sm-12">Select Health Condition:</label>
                        <div class="col-sm-12 border-bottom">
                            <select class="form-select shadow-none border-0 ps-0 form-control-line" name="hc">
                                <?php 
                                        				require "connection.php"; 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12 border-bottom">
                                <select class="form-select shadow-none border-0 ps-0 form-control-line" name="hc_severity">
                 ...
                 <input type="hidden" name="id" value="<?php echo $userData['id'] ?>">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12 d-flex">
                            <button class="btn btn-success mx-auto mx-md-0 text-white" type="submit" name="submit">Save</button>
                        </div>
                    </div>
                </form>
                            </div>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <h2 class="card-title">View Health Conditions</h2>
                                <div class="table-responsive">
                                    <table class="table user-table no-wrap">
                                        ...
                                        <tbody>
                                            ...
                                            $uid=$userData['id'];
												require "connection.php"; 
												$sql = "SELECT * FROM health_condition where uid=$uid";
												$result = mysqli_query($conn, $sql);
												while($row = mysqli_fetch_array($result))
												{
												    $fid=$row['fid'];
										    $sql1 = "SELECT * FROM familymember where fid=$fid ";
											$result1 = mysqli_query($conn, $sql1);
											$row1 = mysqli_fetch_array($result1);
													$health_condition=$row['health_condition'];
													$hc_severity=$row['hc_severity'];
												?>
                                            <tr>
                                                <td><?php echo $row1['name'] ?></td>
                                                <td><?php echo $health_condition ?></td>
                                                <td><?php echo $hc_severity ?></td>
