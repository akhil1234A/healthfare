            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Add Your Food</h3>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Add Your Food</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h2 class="card-title">Add Your Food</h2>
                                <form action="insert-food.php" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
									<div class="row">
                                            <label class="col-md-12 mb-0" for="height">Choose Family Member</label>
											    <div class="col-md-12">
								<select id="profileSwitch" name="member" class="form-select" required>
								 ...
								 <?php
									...
									<?php } ?>
                                        ...
                                        <div class="row">
                                            <label class="col-md-12 mb-0" for="height">Choose Dietitian</label>
											    <div class="col-md-12">
								<select id="profileSwitch" name="doctor" class="form-select" required>
								 
								 <?php
									require "connection.php"; 
									$query = "SELECT * from login where usertype='D'";
									$search_result = mysqli_query($conn, $query);
                                    ...
                                    <input type="hidden" name="id" value="<?php echo $userData['id']; ?>">
                                        <div class="row">
                                            <div class="col-md-12">
                                               </br> <input type="submit" value="Submit" name="submit" class="btn btn-success text-white">
                                            </div>
                                        </div>
                                    </div>
