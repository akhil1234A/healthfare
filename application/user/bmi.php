            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">BMI</h3>
                            ...
                            <div class="card-body">
                                ...
                                <form action="bmi.php" method="get">
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <label class="col-md-12 mb-0" for="height">Height (in cm):</label>
                                            <div class="col-md-12">
                                                <input type="number" id="height" name="height" required class="form-control ps-0 form-control-line form-control">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <label class="col-md-12 mb-0" for="weight">Weight (in kg):</label>
                                            <div class="col-md-12">
                                                <input type="number" id="weight" name="mass" required class="form-control ps-0 form-control-line form-control">
                                            </div>
                                        </div>
                                    
                                        <div class="row">
                                            <label class="col-md-12 mb-0" for="age">Age:</label>
                                            <div class="col-md-12">
                                                <input type="number" id="age" name="age" required class="form-control ps-0 form-control-line form-control">
                                            </div>
                                        </div>
                                    
                                        <div class="row">
                                            <label class="col-md-12 mb-0" for="sex">Sex:</label>
                                            <div class="col-md-12">
                                                <select id="sex" name="sex" required class="form-control ps-0 form-control-line form-control">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12"></br>
                                                <input type="submit" value="Calculate BMI" name="submit" class="btn btn-success text-white">
                                            </div>
                                        </div>
                                    </div>
								   ...
								   <h2 class="card-title">Result:</h2>
									<div id="result-container">
										 ...
										 <?php
											...
											$mass = $_GET['mass'];
											$height_in_cm = $_GET['height'];
											$height=$height_in_cm*0.01;
