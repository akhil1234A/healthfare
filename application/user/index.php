                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-md-flex">
                                    <h4 class="card-title col-md-10 mb-md-0 mb-3 align-self-center">Appointment Status</h4>
                    ...
                    <div class="row">
                     <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-md-flex">
                                    <h4 class="card-title col-md-10 mb-md-0 mb-3 align-self-center">Food Review Status</h4>
                                ...
                                <div class="table-responsive mt-5">
                                    <table class="table stylish-table no-wrap">
                                        <thead>
                                            <tr>
                                                <th class="border-top-0" >Family Member</th>
                                        ...
                                        <tbody> 
											...
											$id=$userData['id'];
											require "connection.php"; 
											$sql = "SELECT * FROM food_review where user=$id ";
											$result = mysqli_query($conn, $sql);
											while($row = mysqli_fetch_array($result))
											{
											$member=$row['family_member'];
										    $sql1 = "SELECT * FROM familymember where fid=$member ";
											$result1 = mysqli_query($conn, $sql1);
											$row1 = mysqli_fetch_array($result1);
												$did=$row['did'];
										    $sql2 = "SELECT * FROM login where id=$did ";
