        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Edit Profile Picture</h3>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Edit Profile Picture</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body profile-card">
                                <center><h2 class="card-title">Edit Profile Picture</h2></center>
                                <form action="update-profilepic.php" method="post" enctype="multipart/form-data">
				...
				while($row = mysqli_fetch_array($result))
				{
					...
					?>
 <center> <img src="<?php echo $image; ?>" id="output" class="rounded-circle" style="width:50%" /></center> </br></br>
</br>

   <input type="file" onchange="loadFile(event)" name="image" class="form-control" style="margin-top:3%"></br>
