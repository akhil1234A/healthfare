        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-12 align-self-center">
                        <h3 class="page-title mb-0 p-0">Add Your Meals</h3>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Add Your Meals</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                <div class="container-fluid">
                    ...
                    <div class="row">
                    <!-- Column -->
				<form action="findmeal.php" method="get">
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
					...
					<div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                           <a href="add-food.php"> <div class="card">
                                <img class="card-img-top img-responsive" src="assets/images/big/OIP.jpeg" alt="Card">
                                <div class="card-body">
                                    <center>
                                        <h3 class=" font-normal" >Add Your Food</h3>
                                    </center>
						...
						$fid=$_GET['member'];
$sql = "SELECT * FROM food_review WHERE family_member='$fid' && user = '" . $userData['id'] . "' ";
$result = mysqli_query($conn, $sql);
while($row = mysqli_fetch_array($result))
				{
					?>
						...
						<?php }  }
							...
							$sql = "SELECT * FROM food_review WHERE user = '" . $userData['id'] . "' && status='Completed'";
$result = mysqli_query($conn, $sql);
while($row = mysqli_fetch_array($result))
				{
					?>
