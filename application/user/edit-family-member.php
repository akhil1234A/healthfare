	...
	<li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Edit Family Member</h3>
            ...
            <div class="container-fluid">
				...
				require "connection.php"; 
				$id=$_GET['id'];
				$sql = "SELECT * FROM familymember WHERE fid = $id";
				$result = mysqli_query($conn, $sql);
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h2 class="card-title">Edit Family Member</h2>
                                <form action="update-family-member.php" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                         
 
  <img src="<?php echo $image; ?>" id="output" class="rounded-circle" width="150" /></br></br>
  <label class="col-md-12" for="weight">Change Image</label>

   <input type="file" onchange="loadFile(event)" name="image" class="form-control"></br>

                                        <div class="row">
                                            <label class="col-md-12 " for="height">Name</label>
                                            <div class="col-md-12">
                                                <input type="text" name="name"  class=" form-control-line form-control" value="<?php echo $name; ?>">
                                            </div>
                                        </div><br>
                                        <div class="row">
                                            <label class="col-md-12" for="weight">Relation</label>
                                            <div class="col-md-12">
                                                <input type="text"name="relation"  class="  form-control-line form-control" value="<?php echo $relation ?>">
                                            </div>
                                        </div>
