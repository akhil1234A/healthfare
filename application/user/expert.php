            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Book Your Appointments</h3>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Connect with Experts</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
							<form method="post" action="book-call.php">
                                <div class="form-group">
                                    <div class="row mb-3">
                                        <label class="col-md-12 mb-0" for="name">Name:</label>
                                        <div class="col-md-12">
                                            <input type="text" name="name" required class="form-control ps-0 form-control-line">
                                        </div>
                                    </div>
                                     
                                    
                                 <div class="row mb-3">
                                        <label class="col-md-12 mb-0" for="name">Phone:</label>
                                        <div class="col-md-12">
                                            <input type="text" name="phone" required class="form-control ps-0 form-control-line">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label class="col-md-12 mb-0" for="email">Email:</label>
                                        <div class="col-md-12">
                                            <input type="email"  name="email" required class="form-control ps-0 form-control-line">
                                        </div>
                                    </div>
                                 <div class="row mb-3">
                                        <label class="col-md-12 mb-0" for="doctor">Doctor:</label>
                                        <div class="col-md-12">
                                            <select  name="doctor" required class="form-control ps-0 form-control-line">
                                                <?php
                                                require "connection.php";
                                        ...
                                        while($row = mysqli_fetch_array($result))
                                        	{
                                                ?>
                                                <option value="<?php echo $row['name']; ?>"><?php echo $row['name']; ?> (<?php echo $row['specialization']; ?>)</option>
                                           <?php  } ?>   
                                                </select>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                         <label class="col-md-12 mb-0" for="date">Preferred Date:</label>
                                                <div class="col-md-12">
                                           <input type="date" id="date" name="date" required class="form-control ps-0 form-control-line">
                                        </div>
                                    </div>
                                
                                    <div class="row mb-3">
                                         <label class="col-md-12 mb-0" for="time">Preferred Time:</label>
                                                <div class="col-md-12">
                                           <input type="time" name="time" required class="form-control ps-0 form-control-line">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="submit" name="submit" value="Book Call"  class="btn btn-success text-white">
                                        </div>
                                    </div>
                                </div>
                                </form>
