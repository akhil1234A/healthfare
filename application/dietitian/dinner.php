			...
			<div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Dinner</h3>
            ...
            <div class="container-fluid">
                ...
                <?php 
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h2 class="card-title">Update Dinner</h2>
                                <form action="insert-dinner.php" method="post"  enctype="multipart/form-data">
				  ...
				  <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h2 class="card-title">Add Dinner</h2>
                                <form action="insert-dinner.php" method="post"  enctype="multipart/form-data">
                                    <div class="form-group">
                                ...
                                <?php 
                                        ...
                                        <div class="row">
                                        	...
                                        	<input type="hidden" name="type" class="form-control" value="Dinner">
                                        <div class="row">
                                            <div class="col-md-12">
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Dinner</h6>
                                <div class="table-responsive">
                                    <table class="table user-table no-wrap">
                                        ...
                                        <tbody>
                                            <?php 
												require "connection.php"; 
												$sql = "SELECT * FROM foods where type='Dinner'";
												$result = mysqli_query($conn, $sql);
												while($row = mysqli_fetch_array($result))
												{
													$name=$row['name'];
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="dinner.php?id=<?php echo $row['fdid']; ?>"class="btn btn-primary">Edit </a></td>
                                                 <td>
			<?php echo" <a class='btn btn-danger' style='color:white' onClick=\"javascript: return confirm('Please confirm deletion');\" href='dinner.php?fdid=".$row['fdid']."'>Delete</a> "; ?>
			</td>
                                            </tr>
                                           <?php } ?>
