            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Call Requests</h3>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">View All Requests</h6>
                                <div class="table-responsive">
                                    <table class="table user-table no-wrap">
                                        <thead>
                                            <tr>
                                                <th class="border-top-0">Call ID</th>
                                        ...
                                        <tbody>
                                           <?php 
											...
											while($row = mysqli_fetch_array($result))
												...
												<td><a href="tel:<?php echo $phone ?>"><i class=" fas fa-phone-square"> Call</i></a></td>
												<td><a href="edit-callsupport.php?id=<?php echo $row['aid']; ?>"class="btn btn-primary">Edit </a></td>
