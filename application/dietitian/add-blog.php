                                ...
                                <form action="insert-blog.php" method="post"  enctype="multipart/form-data">
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
											<label class="col-md-12 mb-0" for="height">Image</label>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
											<label class="col-md-12 mb-0" for="weight">Title</label>
                                                <input type="text" name="title"  class="form-control ps-0 form-control-line form-control">
                                            </div>
											
                                        </div>
                                    <input type="hidden" name="id" value="<?php echo $userData['id'] ?>">
                                        <div class="row">
                                            <label class="col-md-12 mb-0" for="age">Content</label>
                                            <div class="col-md-12">
