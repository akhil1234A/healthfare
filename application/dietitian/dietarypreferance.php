			...
			<div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Dietary Preferance</h3>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Dietary Preferance</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <!-- ============================================================== -->
                  <?php 
												...
												$sql = "SELECT * FROM dietary_pref where dpid=$id";
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h2 class="card-title">Update Dietary Preferance</h2>
                                <form action="insert-dietary-preferance.php" method="post"  enctype="multipart/form-data">
                                        <div class="form-group">
                                             <div class="row">
                                            <label class="col-md-12 mb-0" >Dietary Preference</label>
                                            <div class="col-md-12">
													<input type="text" name="dietary_pref" class="form-control" value="<?php echo $dietary_pref ?>">
												</div>
                                        </div>
                                         <div class="row">
                                        ...
                                        <input type="hidden" name="id" class="form-control" value="<?php echo $dpid ?>" >
                                        <div class="row">
                                            <div class="col-md-12">
				  ...
				  <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h2 class="card-title">Add Dietary Preference</h2>
                                <form action="insert-dietary-preferance.php" method="post"  enctype="multipart/form-data">
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <label class="col-md-12 mb-0" >Dietary Preference</label>
                                            <div class="col-md-12">
													<input type="text" name="dietary_pref" class="form-control" >
												</div>
                                        </div>
                                         <div class="row">
                                            <label class="col-md-12 mb-0" >Description</label>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Dietary Preference</h4>
                                <h6 class="card-subtitle">Dietary Preferance</h6>
                                    ...
                                    <table class="table user-table no-wrap">
                                        ...
                                        <tbody>
                                            <?php 
												...
												?>
                                            <tr>
                                                <td><?php echo $dietary_pref ?></td>
                                                <td><?php echo $description ?></td>
                                                <td><a href="dietarypreferance.php?id=<?php echo $row['dpid']; ?>"class="btn btn-primary">Edit </a></td>
                                                 <td>
			<?php echo" <a class='btn btn-danger' style='color:white' onClick=\"javascript: return confirm('Please confirm deletion');\" href='dietarypreferance.php?dpid=".$row['dpid']."'>Delete</a> "; ?>
			</td>
                                            </tr>
                                           <?php } ?>
...
{
$uid=$_GET['dpid'];
$insert2="delete from dietary_pref where dpid=$uid";
$sql_insert1=mysqli_query($conn,$insert2);
  echo "<script>
                window.location.href='dietarypreferance.php';
            </script>";
}
?>
            <!-- ============================================================== -->
