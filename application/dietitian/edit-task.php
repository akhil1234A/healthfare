...
$sql = "SELECT * FROM dietition WHERE username = '" . $_SESSION['username'] . "'";
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Assigned Works</h3>
                ...
                <!-- ============================================================== -->
                 <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h2 class="card-title">Edit Tasks</h2>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
											...
											<label class="col-md-12 mb-0" for="height">Task Type</label>
                                                <input type="text" name="type"  class="form-control ps-0 form-control-line form-control" value="<?php echo $row['type'] ?>">
                                            </div>
											 <div class="col-md-6">
                                        ...
                                        <div class="row">
											...
											<label class="col-md-12 mb-0" for="weight">Dietitian Name</label>
                                                <input type="text" name="dietitian"  class="form-control ps-0 form-control-line form-control" value="<?php echo $row['dietitian'] ?>">
                                            </div>
											 <div class="col-md-6">
											 <label class="col-md-12 mb-0" for="weight">Assigned Date</label>
                                                <input type="date" name="date"  class="form-control ps-0 form-control-line form-control" value="<?php echo $row['date'] ?>">
                                            </div>
                                        </div>
