        ...
        <div class="page-wrapper">
			...
			<div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Breakfast</h3>
            ...
            <div class="container-fluid">
                ...
                <?php 
												...
												$sql = "SELECT * FROM foods where fdid=$id ";
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h2 class="card-title">Update Breakfast</h2>
                                <form action="insert-breakfast.php" method="post"  enctype="multipart/form-data">
                                        <div class="form-group">
                                             <div class="row">
                                            <label class="col-md-12 mb-0" >Food Name</label>
                                            <div class="col-md-12">
													<input type="text" name="name" class="form-control" value="<?php echo $name ?>">
												</div>
                                        </div>
                                        <div class="row">
                                            <label class="col-md-12 mb-0" >Nutrirional Info</label>
                                            <div class="col-md-12">
													<input type="text" name="nutri_info" class="form-control" value="<?php echo $nutri_info ?>" >
												</div>
                                        </div>
                                        <div class="row">
                                            <label class="col-md-12 mb-0" >Ingredients</label>
                                            <div class="col-md-12">
													<input type="text" name="ingredients" class="form-control" value="<?php echo $ingredients ?>">
												</div>
                                        </div>
                                         <div class="row">
                                            <label class="col-md-12 mb-0" >Recipe</label>
                                            <div class="col-md-12">
													<textarea name="recipe" class="form-control" ><?php echo $recipe ?></textarea>
												</div>
                                        </div>
                                        <div class="row">
                                            <label class="col-md-12 mb-0" >Calories</label>
                                            <div class="col-md-12">
													<input type="text" name="calories" class="form-control" value="<?php echo $calories ?>">
												</div>
                                        </div>
                                        <input type="hidden" name="id" class="form-control" value="<?php echo $fdid ?>" >
                                        <div class="row">
                                            <div class="col-md-12">
				  ...
				  <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h2 class="card-title">Add Breakfast</h2>
                                <form action="insert-breakfast.php" method="post"  enctype="multipart/form-data">
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <label class="col-md-12 mb-0" >Nutrirional Info</label>
                                            <div class="col-md-12">
													<input type="text" name="nutri_info" class="form-control" >
												</div>
                                        </div>
                                        <div class="row">
                                            <label class="col-md-12 mb-0" >Ingredients</label>
                                         ...
                                         <div class="row">
                                            <label class="col-md-12 mb-0" >Recipe</label>
                                            <div class="col-md-12">
													<textarea name="recipe" class="form-control" ></textarea>
												</div>
                                        </div>
                                        <div class="row">
                                            <label class="col-md-12 mb-0" >Calories</label>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
													<select class="form-control" name="hc">
													    <option>Choose Health Condition</option>
                                <?php 
                                        				require "connection.php"; 
                                        			...
                                        			?>
                                                <option value="<?php echo $health_condition ?>"><?php echo $health_condition ?></option>
                                                <?php } ?>
                            </select>
												</div>
                                        </div>
                                        <div class="row">
                                            <label class="col-md-12 mb-0" for="age">Food Image</label>
                                            <div class="col-md-12">
                                                <input type="file" name="image"  class="form-control ps-0 form-control-line form-control">
                                            </div>
                                        </div>
                                        	<input type="hidden" name="type" class="form-control" value="Breakfast">
                                        <div class="row">
                                            <div class="col-md-12">
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Breakfast</h6>
                                <div class="table-responsive">
                                    <table class="table user-table no-wrap">
                                        <thead>
                                            <tr>
                                                    <th class="border-top-0">Food Name</th>
                                                <th class="border-top-0">Nutritional Info</th>
                                                <th class="border-top-0">Ingredients</th>
                                                <th class="border-top-0">Recipe</th>
                                        ...
                                        <tbody>
                                            <?php 
												require "connection.php"; 
												$sql = "SELECT * FROM foods where type='breakfast'";
												$result = mysqli_query($conn, $sql);
												while($row = mysqli_fetch_array($result))
												{
													$name=$row['name'];
                                            ...
                                            <tr>
                                                <td><?php echo $name ?></td>
                                                <td><?php echo $nutri_info ?></td>
                                                <td><?php echo $ingredients ?></td>
                                                <td><?php echo $recipe ?></td>
                                                <td><?php echo $calories ?></td>
                                                <td><a href="breakfast.php?id=<?php echo $row['fdid']; ?>"class="btn btn-primary">Edit </a></td>
                                                 <td>
			<?php echo" <a class='btn btn-danger' style='color:white' onClick=\"javascript: return confirm('Please confirm deletion');\" href='breakfast.php?fdid=".$row['fdid']."'>Delete</a> "; ?>
			</td>
                                            </tr>
                                           <?php } ?>
...
{
$uid=$_GET['fdid'];
$insert2="delete from foods where fdid=$uid";
